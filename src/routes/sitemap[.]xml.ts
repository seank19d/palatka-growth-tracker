    ...
    handlers: {
      GET: async () => {
        ...
        const paths: Array<{ loc: string; lastmod: string; changefreq: string; priority: string }> = [
          ...
          { loc: "/storm", lastmod: fallback, changefreq: "weekly", priority: "0.9" },
          { loc: "/house", lastmod: fallback, changefreq: "weekly", priority: "0.85" },
          { loc: "/summer", lastmod: fallback, changefreq: "weekly", priority: "0.8" },
          { loc: "/well", lastmod: fallback, changefreq: "weekly", priority: "0.8" },
          { loc: "/office", lastmod: fallback, changefreq: "weekly", priority: "0.75" },
