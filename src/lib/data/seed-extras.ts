export const SEED_PRODUCTS: {
...
}[] = [
  {
    ...
    searchQuery: "Bankers Box SmoothMove small moving boxes 15 pack",
    sortOrder: 1,
  },
  {
    asin: "B000087KUA",
    ...
    searchQuery: "Scotch 3850 heavy duty packing tape 6 pack",
    sortOrder: 2,
  },
  {
    asin: "B000069EYA",
    ...
    searchQuery: "First Aid Only 298 piece all purpose first aid kit",
    sortOrder: 3,
  },
  {
    asin: "B0CYFJL7QR",
    ...
    searchQuery: "CRAFTSMAN 102 piece home and car tool kit",
    sortOrder: 4,
  },
  {
    asin: "B003PWNH4Q",
    ...
    searchQuery: "SafeRest waterproof queen mattress protector",
    sortOrder: 5,
  },
  {
    asin: "B073VBWKJZ",
    ...
    searchQuery: "hOmeLabs 50 pint dehumidifier basement",
    sortOrder: 6,
  },
  {
    asin: "B000E5WAUO",
    ...
    searchQuery: "Vornado 630 medium air circulator fan",
    sortOrder: 7,
  },
  {
    asin: "B00520874Y",
    ...
    searchQuery: "nuLOOM indoor outdoor rug 5x7 patio",
    sortOrder: 8,
  },
  {
    asin: "B00RFXS1Z6",
    ...
    searchQuery: "Weber Q1200 portable propane grill",
    sortOrder: 9,
  },
  {
    asin: "B003TFE7ZM",
    ...
    category: "outdoor",
    blurb: "New sod, well water, and sandy soil. A long hose is not overkill.",
    searchQuery: "Flexzilla 50 foot 5/8 garden hose",
    sortOrder: 10,
  },
  {
    asin: "B015QIC1PW",
  ...
  },
  {
    ...
    searchQuery: "Energizer LED camping lantern battery",
    sortOrder: 12,
  },
  {
    asin: "B09WZJ81JQ",
    ...
    searchQuery: "Cutter Backyard Bug Control spray concentrate mosquitoes",
    sortOrder: 13,
  },
  {
    asin: "B000KKM8EG",
    ...
    searchQuery: "Gila Heat Control Platinum window film 36 inch",
    sortOrder: 14,
  },
  {
    asin: null,
    ...
    category: "storm",
    blurb: "The item people actually use: fridge for a few hours, phones, a lamp. Charge it on a quiet Tuesday.",
    searchQuery: "Jackery Explorer 300 portable power station",
    sortOrder: 15,
  },
  {
    asin: null,
    ...
    category: "storm",
    blurb: "A well pump is an electric appliance. City pressure can still drop. Store water you can lift.",
    searchQuery: "Reliance Aqua-Tainer 7 gallon water container",
    sortOrder: 16,
  },
  {
    asin: null,
    ...
    category: "storm",
    blurb: "If a generator lives anywhere near the house, the detector goes inside — not on the unit.",
    searchQuery: "First Alert battery carbon monoxide detector",
    sortOrder: 17,
  },
  {
    asin: null,
    ...
    searchQuery: "Yellow Jacket 50 foot 12 gauge outdoor extension cord",
    sortOrder: 18,
  },
  {
    asin: null,
    ...
    category: "storm",
    blurb: "After standing water around a wellhead in East Palatka, test it. Color is not a lab.",
    searchQuery: "Safe Home well drinking water test kit",
    sortOrder: 19,
  },
  {
    asin: null,
    ...
    category: "storm",
    blurb: "Radios, lanterns, detectors. Buy the pack in August, not the night before a named storm.",
    searchQuery: "Amazon Basics AA batteries 48 pack",
    sortOrder: 20,
  },
  {
    asin: null,
    title: "Cooler",
    category: "storm",
    blurb: "If the outage lasts overnight, this is the fridge. Ice from a working gas station beats a thawed freezer.",
  ...
  },
  {
    ...
    category: "storm",
    blurb: "Older Palatka roofs and yard debris. A poly tarp and a tool kit beat a sandbag photo.",
    searchQuery: "heavy duty poly tarp 10x12 waterproof",
    sortOrder: 22,
  },
];
