export const SEED_PRODUCTS: {
  ...
  },
  {
    ...
    category: "outdoor",
    blurb: "Screened porch or lanai. Start with a washable outdoor rug.",
  ...
  },
  {
    ...
    category: "outdoor",
    blurb: "River and wetlands. Treat the yard before dusk if you’re sitting outside.",
  ...
  },
  {
    ...
    searchQuery: "DampRid refillable moisture absorber unscented",
    sortOrder: 23,
  },
  {
    asin: null,
    ...
    searchQuery: "ThermoPro indoor humidity thermometer hygrometer",
    sortOrder: 24,
  },
  {
    asin: null,
  ...
  },
  {
    ...
    searchQuery: "Brita tap water filtration system",
    sortOrder: 26,
  },
  {
    asin: null,
    ...
    searchQuery: "eero 6 mesh wifi system 3 pack",
    sortOrder: 27,
  },
  {
    asin: null,
    ...
    searchQuery: "APC BE600M1 UPS battery backup",
    sortOrder: 28,
  },
  {
    asin: null,
    ...
    searchQuery: "Cat 6 ethernet cable 50 ft snagless",
    sortOrder: 29,
  },
  {
    asin: null,
    ...
    searchQuery: "LED desk lamp for home office adjustable",
    sortOrder: 30,
  },
  {
    asin: null,
    ...
    searchQuery: "Thermacell patio mosquito repeller",
    sortOrder: 31,
  },
  {
    asin: null,
  ...
  },
  {
    ...
    searchQuery: "Klein Tools GFCI receptacle tester",
    sortOrder: 33,
  },
  {
    asin: null,
    ...
    searchQuery: "FrogTape multi surface painter's tape",
    sortOrder: 34,
  },
  {
    asin: null,
...
export const SEED_FAQS: { question: string; answer: string; sortOrder: number }[] = [
  ...
  },
  {
    ...
    answer:
      "Yes. The Collection at Palatka (508 N. 17th Street) and Nobles Crossing (Newcastle Road) are listed as selling on Century Complete. Advertised bands: Collection low-to-mid $200s; Nobles recent asks low-to-mid $300s — verify live. Alford Farms in East Palatka is not selling lots in the public record this site reviews.",
    sortOrder: 1,
  },
  {
